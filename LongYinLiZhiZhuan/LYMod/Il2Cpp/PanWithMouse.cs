...
public class PanWithMouse : MonoBehaviour
{
	...
	static PanWithMouse()
	{
		Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "", "PanWithMouse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr);
		NativeFieldInfoPtr_degrees = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, "degrees");
		NativeFieldInfoPtr_range = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, "range");
		NativeFieldInfoPtr_mTrans = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, "mTrans");
		NativeFieldInfoPtr_mStart = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, "mStart");
		NativeFieldInfoPtr_mRot = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, "mRot");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, 100669628);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, 100669629);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr, 100669630);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 208143, XrefRangeEnd = 208153, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PanWithMouse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PanWithMouse>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PanWithMouse(IntPtr pointer)
		: base(pointer)
	{
	}
}
